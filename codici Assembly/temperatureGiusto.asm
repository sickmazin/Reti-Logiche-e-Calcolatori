...
;Dunque, sia V un vettore di dimensione 2*n in cui ciascun elemento in posizione pari contiene la temperatura minima in una certa città 
;e l’elemento immediatamente successivo contiene la temperatura massima rilevata nella stessa città. 
...
;
;Si scriva, inoltre, un programma principale che ilenochi correttamente la procedura descritta.
